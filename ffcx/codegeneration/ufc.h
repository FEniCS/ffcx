...
#define restrict
  ...
  /// a reference cell.
  ///
  /// Represents a k-linear functional
  ///
  /// expr: V1 x V2 x ... x Vk -> R^n,
  ///
  /// where n is (number of evaluation points x number of expression component
  ///
  ...
  typedef struct ufc_expression
  {
    ...
    /// Reference coordinates of evaluations points.
