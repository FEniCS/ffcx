...
.. note:: TSFC requirements are not installed in FEniCS Docker
    ...
    on demand::
        ...
        sudo apt-get update && sudo apt-get -y install glpk-utils && \
          ...
          git+https://github.com/blechta/tsfc.git@tsfc-2017.1.0 \
          git+https://github.com/blechta/COFFEE.git@COFFEE-2017.1.0 \
          git+https://github.com/blechta/FInAT.git@FInAT-2017.1.0 \
