...
\begin{figure}[htbp]
  \begin{center}
    ...
    \psfrag{2}{$2$}
    \psfrag{3}{$3$}
    %FIXME\includegraphics[width=8cm]{eps/numbering_example_triangles.eps}
...
\begin{figure}[htbp]
  \begin{center}
    ...
    \psfrag{4}{$4$}
    \psfrag{5}{$5$}
    %FIXME\includegraphics[width=8cm]{eps/numbering_example_quadrilaterals.eps}
...
\begin{figure}[htbp]
  \begin{center}
    ...
    \psfrag{v2}{$v_2$}
    \psfrag{e0}{$e_0$}
    %FIXME\includegraphics[width=5cm]{eps/ordering_example_triangle.eps}
...
\begin{figure}[htbp]
  \begin{center}
    ...
    \psfrag{v3}{$v_3$}
    \psfrag{e0}{$e_0$}
    %FIXME\includegraphics[width=5cm]{eps/ordering_example_tetrahedron.eps}
    \caption{Mesh entities are ordered based on a lexicographical ordering
      of the corresponding ordered tuples of non-incident vertices.
...
\begin{figure}[htbp]
  \begin{center}
    ...
    \psfrag{v2}{$v_2$}
    \psfrag{v3}{$v_3$}
    %FIXME\includegraphics[width=9cm]{eps/orientation_example_triangles.eps}
