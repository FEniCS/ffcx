...
from uflacs.backends.cpp2.compiler import compile_expression_lines

import ufl
from ufl import as_ufl
from ufl import *
from uflacs.algorithms.datastructures import object_array, int_array
...
class CppExpressionCompilerTest(UflTestCase):
    ...
    def test_literal_zero_compilation(self):
    ...
    def test_literal_int_compilation(self):
    ...
    def test_literal_float_compilation(self):
    ...
    def test_geometry_h_compilation(self):
        h = ufl.triangle.circumradius
