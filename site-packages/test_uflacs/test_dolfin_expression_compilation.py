...
class DolfinExpressionFormatterTest(UflTestCase):
    ...
    def test_dolfin_expression_with_cell(self):
        ...
        self.assertEqual(values[0], 1.23)
        #self.assertEqual(e((1.0,2.0)), 1.23) # FAILS! Need dolfin to dispatch this to eval_cell with the proper Cell found from x for this to work.
