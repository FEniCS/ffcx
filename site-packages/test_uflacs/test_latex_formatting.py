...
class LatexFormatterTest(UflTestCase):
    ...
    def test_latex_formatting_of_arithmetic(self):
        ...
        self.assertLatexEqual(x*x, r"{x_0}^{2}") # TODO: Will gcc optimize this to x*x for us?
        self.assertLatexEqual(x**3, r"{x_0}^{3}")
        # TODO: Test all basic operators

    def test_latex_formatting_of_cmath(self):
        x = ufl.SpatialCoordinate(ufl.triangle)[0]
        self.assertLatexEqual(ufl.exp(x), r"e^{x_0}")
    ...
    def test_latex_formatting_of_derivatives(self):
        ...
        self.assertLatexEqual(ufl.grad(xx)[0,0], "1")
        self.assertLatexEqual(ufl.grad(xx)[0,1], "0")
    ...
    def test_latex_formatting_precedence_handling(self):
        ...
        self.assertLatexEqual(ufl.asin(ufl.atan(x**4)), r"\arcsin(\arctan({x_0}^{4}))")
        ...
        self.assertLatexEqual(2 * (x + 3) * y, "x_1 (2 (3 + x_0))")
    def _fixme(self):
        self.assertLatexEqual(2 * (x + 3)**4 * y, "x_1 (2 {(3 + x_0)}^{4)") # FIXME: Precedence handling fails here
    ...
    def test_latex_formatting_of_variables(self):
        ...
        self.assertLatexEqual(x**2 + y**2, r"{z}^{2} + y2", variables={x: 'z', y**2: 'y2'})
        ...
        self.assertLatexEqual(f**3, r"{f}^{3}", variables={f: 'f'})
