...
class Ufl2CppFormatterTest(UflTestCase):
    ...
    def test_cpp_formatting_of_derivatives(self):
        ...
        #self.assertCppEqual(ufl.Identity(2)[0,0].dx(0), "0") # FIXME: Worked before
        #self.assertCppEqual(x.dx(0), "1") # FIXME: Worked before
        #self.assertCppEqual(x.dx(1), "0") # FIXME: Worked before
        #self.assertCppEqual(ufl.grad(x)[0,0], "1") # FIXME: Seems to be a bug
        #self.assertCppEqual(ufl.grad(x)[0,1], "0") # FIXME: Seems to be a bug
