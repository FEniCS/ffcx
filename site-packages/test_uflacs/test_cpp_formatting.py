...
from uflacs.codeutils.target_formatter import CppLanguageFormatter, DependencyHandler
...
def format_expression_as_test_cpp(expr, variables=None):
    ...
    cpp_formatter = CppLanguageFormatter(DependencyHandler({}), {})
...
class PureCppFormatterTest(UflTestCase):
    ...
    def test_cpp_literal_formatter(self):
        fmt = uflacs.codeutils.cpp_format.CppLiteralFormatterRules()
    ...
    def test_cpp_arithmetic_formatter(self):
        fmt = uflacs.codeutils.cpp_format.CppArithmeticFormatterRules()
    ...
    def test_cpp_cmath_formatter(self):
        fmt = uflacs.codeutils.cpp_format.CppCmathFormatterRules()
        ...
        self.assertEqual(fmt.abs(None, "x"), "abs(x)")
    ...
    def test_cpp_conditional_formatter(self):
        fmt = uflacs.codeutils.cpp_format.CppConditionalFormatterRules()
...
class Ufl2CppFormatterTest(UflTestCase):
    ...
    def test_cpp_formatting_of_cmath(self):
        ...
        self.assertCppEqual(abs(x), "abs(x[0])")
