...
class CodeUtilsTest(UflTestCase):
    ...
    def test_format_code_template_argument_list(self):
    ...
    def test_format_code_templated_type(self):
        self.assertEqual(format_code(Type('Foo')),
                         'Foo')
        self.assertEqual(format_code(Type('Foo', ('int', '123'))),
                         'Foo<int, 123>')
        self.assertEqual(format_code(Type('Foo', ('int', Type('Bar', ('123', 'float'))))),
                         'Foo<int, Bar<123, float> >')

    def test_format_code_typedef(self):
        self.assertEqual(format_code(TypeDef('int', 'myint')),
                         'typedef int myint;')
        self.assertEqual(format_code(TypeDef(Type('Foo', ('int', Type('Bar', ('123', 'float')))), 'Thing')),
                         'typedef Foo<int, Bar<123, float> > Thing;')

    def test_format_code_template_class(self):
