...
class CppStatementFormatter(object):
    ...
    def define_piecewise_geometry(self):
        lines = ["// Computing piecewise constant geometry:"]
        ...
        for r in needed.get("J", ()):
            lines.extend(generate_jacobian_snippets(self._cell, r))
        # TODO: Separate detJ computation
        for r in needed.get("K", ()):
            lines.extend(generate_jacobian_inverse_snippets(self._cell, r))

        # TODO: Add all cell geometry stuff here, cell volume etc.
        #for r in needed.get("volume", ()):
        #    lines.extend(generate_volume_snippets(self._cell, r))
        #for r in needed.get("circumradius", ()):
        #    lines.extend(generate_circumradius_snippets(self._cell, r))
    ...
    def _define_piecewise_geometry(self):
        ...
        for name, restriction in ordered:
            lines.append('// TODO: Compute %s%s here' % (name, restriction))
    ...
    def define_coord_vars(self):
        ...
        #       defining x from xi or xi from x?
        #       (and we don't always need both...)
        ...
        # FIXME: Use correct name for 'det', depending on integral type?
        code += ["const double D = qw * det;"]
        return code
...
def test():
    ...
    # TODO: Also needs to know about integration context
    cell = triangle
...
def test2():
    ...
    language_formatter = CppLanguageFormatter(dependency_handler, {})
    statement_formatter = CppStatementFormatter(dependency_handler, triangle)
