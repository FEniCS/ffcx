...
# TODO: Use term modified_terminal instead of terminalish everywhere, and let it be scalar everywhere!
...
def analyse_modified_terminal(o):
    ...
    derivatives = sorted(derivatives) # TODO: Change to (x,y,z) format here?
...
def analyse_terminalish(o):
    ...
    #        In that case we change this function to take a scalar modified terminal.
    #        And return actual derivative directions instead of just ngrad.
    # TODO: Use term modified_terminal instead of terminalish everywhere.
    while not isinstance(t, Terminal):
...
class DependencyHandler(object):
    ...
    def __init__(self, modified_terminals, form_argument_mapping=None, object_names=None):
        ...
        self.terminal_data = [analyse_modified_terminals(o) for o in self.modified_terminals]
