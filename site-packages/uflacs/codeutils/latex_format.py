...
class LatexFormArgumentFormatterRules(object):
    ...
    def coefficient(self, o, component=(), derivatives=(), restriction=None):
        ...
        return self.form_argument(o, component, derivatives, 'w', restriction)

    def argument(self, o, component=(), derivatives=(), restriction=None):
        # TODO: Use function mapping
        uflacs_assert(o.count() >= 0, "Expecting positive count, have you preprocessed the expression?")
        return self.form_argument(o, component, derivatives, 'v', restriction)

    def form_argument(self, o, component, derivatives, common_name, restriction):
