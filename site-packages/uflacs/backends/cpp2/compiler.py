...
def compile_expression_body(expr, target_formatter, integrate=False):
    # ------------- FIXME: This is the ir:

    # TODO: Instead of attaching data to target_formatter, return it from here:
    ...
    # ------------- FIXME: This is the code generation:
    ...
    partition_codes, final_variable_names = generate_code_from_ssa(
        SV, active, partitions, allocations, target_registers, expr_formatter)

    code = generate_expression_body(target_formatter, partition_codes, final_variable_names, num_registers, integrate)

    return code

def generate_expression_body(target_formatter, partition_codes, final_variable_names, num_registers, integrate=False):
