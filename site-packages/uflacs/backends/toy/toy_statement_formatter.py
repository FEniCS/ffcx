...
class ToyCppStatementFormatter(object):
    ...
    def __init__(self, dependency_handler, ir):
        ...
        self._enable_accumulation = ir["entitytype"] != None
    ...
    def define_coord_vars(self):
        ...
        if self._enable_accumulation:
            ...
            code += ["const double D = qw * std::fabs(detJ);"] # TODO: Store absolute value?
    ...
    def define_piecewise_coefficients(self):
        ...
        code = ["// %s%d = w[%d][:]" % (names.w, c.count(), c.count(), i)
                for c in enumerate(dh.mapped_coefficients)
