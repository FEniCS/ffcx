...
from uflacs.codeutils.dependency_handler import DependencyHandler, analyse_terminalish # FIXME REFACTORING
...
class DolfinExpressionStatementFormatter(object):
    ...
    def define_piecewise_geometry(self):
        ...
        for o in self._dependency_handler.terminals:
            (t, ngrads, r) = analyse_terminalish(o) # FIXME REFACTORING
