...
from uflacs.backends.cpp2.compiler import compile_expression_body # FIXME
...
def compile_dolfin_expression_body(expr, object_names=None):
    ...
    language_formatter = DolfinExpressionLanguageFormatter(dependency_handler, {})
    # FIXME: Also needs to know about integration context
    statement_formatter = DolfinExpressionStatementFormatter(dependency_handler,
                                                             expr.cell())
    ...
    member_names = dict(constants=[],
                        mesh_functions=[],
                        generic_functions=list(dependency_handler.coefficient_names.values()),
                        functions=[],
                        )
