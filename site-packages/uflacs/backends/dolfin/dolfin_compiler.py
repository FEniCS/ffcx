...
from uflacs.generation.compiler import generate_expression_code, compile_expression_partitions
...
def compile_dolfin_expression_body(expr, parameters, object_names=None):
    ...
    code, dh = generate_expression_code(ir, form_argument_mapping, object_names,
