...
from uflacs.backends.toy.toy_compiler import compile_expression_partitions, generate_expression_code

from .expression import format_dolfin_expression
from .dolfin_language_formatter import DolfinExpressionLanguageFormatter
from .dolfin_statement_formatter import DolfinExpressionStatementFormatter
...
def compile_dolfin_expression_body(expr, object_names=None):
    ...
    coefficient_names = ["w0"] #list(dependency_handler.coefficient_names.values()) # FIXME!!! This makes the tests pass...
    ...
    code = generate_expression_code(ir, cell, form_argument_mapping, object_names,
                                    DolfinExpressionLanguageFormatter, DolfinExpressionStatementFormatter)
