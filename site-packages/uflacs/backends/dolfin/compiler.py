...
def compile_dolfin_expression_body(expr, object_names=None):
    ...
    p = 1
    quadrature_for_loop = None # "for (int iq=0; iq<num_quadrature_points; ++iq)"
    x_dependent_defs = [] # "double x[3] = { quadpoints[iq][0], ... };"
    # FIXME: Compute x dependent geometry, if any?
    # Look at req, term.
    ...
    p = 2
    w_dependent_defs = []
    # FIXME: Compute x dependent coefficients and their gradients.
    # Look at req, term.
