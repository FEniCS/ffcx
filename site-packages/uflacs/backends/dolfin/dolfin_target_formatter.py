...
class DolfinExpressionFormatter(CppDefaultFormatter):
    ...
    def __init__(self, object_names):
        ...
        self._coefficient_basename = "w"
        self._argument_basename = "v"
        self._register_basename = "s"
    ...
    def define_registers(self, num_registers):
        return ['double %s[%d];' % (self._register_basename, num_registers,)]
