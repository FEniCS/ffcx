...
def generate_tabulate_tensor_code(ir, parameters):
    ...
    # HACK!
    num_points, = ir["quadrature_weights"].keys()

    language_formatter = FFCLanguageFormatter(dependency_handler,
                                              ir["function_replace_map"],
                                              ir,
                                              num_points,
                                              ir["cell"]) # TODO: pass only what's needed? Or rather skip other ir[] arguments?
    ...
    statement_formatter = FFCStatementFormatter(dependency_handler,
                                                ...
                                                ir["prim_idims"],
                                                ir) # TODO: pass only what's needed? Or rather skip other ir[] arguments?
