...
def generate_tabulate_tensor_code(ir, parameters):
    ...
    body = generate_expression_body_code(ir, language_formatter, statement_formatter)

    # Format uflacs specific code structures into single strings and place in dict before returning to ffc
    code = {
        "tabulate_tensor": format_code_structure(Indented(body)),
        "using_statements": format_code_structure(Indented(language_formatter.get_using_statements())),
