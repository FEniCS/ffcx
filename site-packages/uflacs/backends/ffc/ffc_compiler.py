...
def build_element_counter_map(integrals_dict):
    element_counter_map = {}
...
def compute_tabulate_tensor_ir(ir,
    ...
    ir["element_map"] = build_element_counter_map(integrals_dict)
...
def build_tables(psi_tables, entitytype, element_counter_map, terminal_data):
    ...
    for t, c, d, r in terminal_data:
        ...
        if isinstance(t, Argument):
            # Group argument tables by t,c for nonzero detection
