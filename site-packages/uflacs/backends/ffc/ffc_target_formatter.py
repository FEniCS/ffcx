...
def get_element_table_data(ir, num_points, element, entity, component, derivatives, restriction):
...
def element_table_access(ir, num_points, element, entity,
                         component, derivatives, restriction, idof):
    unique_table_name, non_zeros, zeros, ones = \
        get_element_table_data(ir, num_points, element, entity, component, derivatives, restriction)
        ...
        for (c,r) in sorted(crdata.keys()):
            ...
            for order in sorted(derivative_orders):
                ...
                for ld in range(tdim):
                    ...
                    (unique_table_name, non_zeros, zeros, ones) = \
                      get_element_table_data(self._ir, self._num_points, element, entity, c, (ld,), r)
