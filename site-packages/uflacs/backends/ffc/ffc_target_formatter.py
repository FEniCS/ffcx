...
class FFCStatementFormatter(object):
    ...
    def _define_coord_dependent_coefficient(self, w, reqdata):
        ...
        # and grouped by derivatives for better code structure
        vdata = []
        ddata = {}
        for ((c,d,r),varname) in reqdata.iteritems():
            c = vi2si[c]
            if d:
                ddata[d] = ddata.get(d,[]) + [(c,r,varname)]
            else:
                vdata += [(c,r,varname)]
