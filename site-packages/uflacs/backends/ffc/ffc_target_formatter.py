    ...
    def _define_coord_dependent_coefficient(self, w, reqdata):
        ...
        for d in sorted(ddata.keys()):
            ...
            for (c,r,varname) in ddata[d]:
                ...
                # FIXME:
                ldvarname = "ld_" + varname
                code.append("double %s[%d] = { %s };" % (ldvarname, tdim, ", ".join(["0.0"]*tdim)))
                body = []
                ...
                for ld in range(tdim):
                    ...
                    body.append(fmt_accum % (fmt_access % (ldvarname, ld), w_fe)) # FIXME
