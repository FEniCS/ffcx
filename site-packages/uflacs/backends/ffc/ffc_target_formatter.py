...
class FFCStatementFormatter(object):
    ...
    def define_coord_dependent_coefficients(self):
        ...
        # FIXME: Compute coefficients here!
        """
        const double %(wname)s = inner_product<%(wdofs)d>(w[%(wcount)d], %(fetable)s[%(iqname)s]);
        """

        # FIXME: Compute mapped coefficient derivatives here!
    ...
    def define_argument_loop_vars(self, argument_count):
        ...
        # FIXME: Compute mapped derivatives of argument here!
