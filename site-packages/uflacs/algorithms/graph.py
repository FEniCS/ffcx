...
def map_list_tensor_symbols(v, G, V_symbols):
    ...
    symbols = FIXME # Need mapping between extended shapes
    return symbols
...
def build_node_symbols(G):
    ...
    for i in xrange(G.nv):
        ...
        if isinstance(v, Indexed):
            ...
            #symbols = map_list_tensor_symbols(v, G, V_symbols) # FIXME
            symbols = new_symbols(n)
        elif isinstance(v, Transposed):
            #symbols = map_transposed_symbols(v, G, V_symbols) # FIXME
            symbols = new_symbols(n)
