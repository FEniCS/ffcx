...
def build_graph_symbols(V, e2i, DEBUG):
    ...
    V_symbols, total_unique_symbols = build_node_symbols(V, e2i, V_sizes)

    return V_shapes, V_sizes, V_symbols, total_unique_symbols
...
def build_graph(expr, DEBUG=False):
    ...
    G.V_shapes, G.V_sizes, G.V_symbols, G.total_unique_symbols = build_graph_symbols(G.V, G.e2i, DEBUG)
    G.V_symbols2 =     G.V_symbols
