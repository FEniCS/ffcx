...
def add_compile_cpp2_options(opts):
    "Args: list of .ufl file(s)."
    pass

def run_compile_cpp2(options, args):
    ...
    from uflacs.backends.cpp2.compiler import compile_element, compile_expression, compile_form
    from uflacs.codeutils.format_code_structure import format_code_structure

    import ufl
    ufl.exproperators.print_collisions()
