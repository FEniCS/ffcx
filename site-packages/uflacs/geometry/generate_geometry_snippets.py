...
circumradius_code = {
    ...
    "triangle": {
        2: ["double circumradius%(r)s;",
            "compute_circumradius_triangle_2d(circumradius%(r)s, vertex_coordinates, J%(r)s, volume%(r)s);"],
        3: ["double circumradius%(r)s;",
            "compute_circumradius_triangle_3d(circumradius%(r)s, vertex_coordinates, J%(r)s, volume%(r)s);"],
        },
    "tetrahedron": {
        3: ["double circumradius%(r)s;",
            "compute_circumradius_tetrahedron_3d(circumradius%(r)s, vertex_coordinates, J%(r)s, volume%(r)s);"],
        }
    }
