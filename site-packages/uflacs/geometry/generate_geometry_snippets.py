...
jacobian_determinants_code = {
    ...
    "triangle": {
        ...
        3: ["double den;", "double det2;", "double detJ;",
...
def generate_jacobian_snippets(cell, restriction):
    ...
    return jacobian_code[cell.cellname()][cell.geometric_dimension()]

def generate_jacobian_determinants_snippets(cell, restriction):
    assert not restriction
    return jacobian_determinants_code[cell.cellname()][cell.geometric_dimension()]

def generate_jacobian_inverse_snippets(cell, restriction):
    assert not restriction
    return jacobian_inverse_code[cell.cellname()][cell.geometric_dimension()]
...
def generate_cell_volume_snippets(cell, restriction):
    assert not restriction
    return cell_volume_code[cell.cellname()][cell.geometric_dimension()]

def generate_circumradius_snippets(cell, restriction):
    assert not restriction
    return circumradius_code[cell.cellname()][cell.geometric_dimension()]

def generate_facet_scaling_factor_snippets(cell, restriction):
    assert not restriction
    return facet_scaling_code[cell.cellname()][cell.geometric_dimension()]

def generate_facet_direction_snippets(cell, restriction):
    assert not restriction
    return facet_direction_code[cell.cellname()][cell.geometric_dimension()]

def generate_facet_normal_snippets(cell, restriction):
    assert not restriction
    return facet_normal_code[cell.cellname()][cell.geometric_dimension()]

def generate_facet_area_snippets(cell, restriction):
    assert not restriction
    return facet_area_code[cell.cellname()][cell.geometric_dimension()]
