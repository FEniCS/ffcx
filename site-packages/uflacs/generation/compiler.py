...
def compile_expression_partitions(expression, form_argument_mapping):
    ...
    # FIXME: Make argument to enable use of this
    tt.step('compute_dependencies')
    if 0: # Disable algorithm
        #AV, FV, IM
        argument_factors, factorized_vertices, argument_factorization = compute_argument_factorization(SV, svs, dependencies)
    ...
    partitions = mark_partitions(SV, active, dependencies, form_argument_mapping)
