...
format.update({
    ...
    "bessel_i":       lambda v, n:  "std::tr1::cyl_bessel_i(%s, %s)" % (str(n), str(v)),
    "bessel_j":       lambda v, n:  "std::tr1::cyl_bessel_j(%s, %s)" % (str(n), str(v)),
    "bessel_k":       lambda v, n:  "std::tr1::cyl_bessel_k(%s, %s)" % (str(n), str(v)),
    "bessel_y":       lambda v, n:  "std::tr1::cyl_neumann(%s, %s)" % (str(n), str(v)),
