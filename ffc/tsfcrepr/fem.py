...
class TabulationManager(object):
    ...
    def __init__(self, integral_type, cell, points, facets):
        ...
        self.facet_manager = FacetManager(integral_type, cell, facets)
...
class FacetManager(object):
    ...
    def __init__(self, integral_type, ufl_cell, facets):
        ...
        if integral_type in ['exterior_facet', 'exterior_facet_vert']:
            ...
            self.facet = {'+': facets[0] if facets else gem.VariableIndex(gem.Indexed(gem.Variable('facet', (2,)), (0,))),
                          '-': facets[1] if facets else gem.VariableIndex(gem.Indexed(gem.Variable('facet', (2,)), (1,)))}
...
def process(integral_type, cell, points, weights, quadrature_index,
    ...
    tabulation_manager = TabulationManager(integral_type, cell, points, facets)
