// This is UFC (Unified Form-assembly Code) v. 2016.2.0.dev0.
...
namespace ufc
{
  ...
  public:
    ...
    /// Return the number of dofs associated with each cell subcomplex of
    /// dimension d
    virtual std::size_t num_subcomplex_dofs(std::size_t d) const = 0;
    ...
    /// Tabulate the local-to-local mapping of dofs on subcomplex of entity (d, i)
    virtual void tabulate_subcomplex_dofs(std::size_t * dofs,
                                          std::size_t d, std::size_t i) const = 0;
