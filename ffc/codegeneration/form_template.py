...
declaration = """
static ufc_form* create_{factory_name}(void);
"""

factory = """
// Code for form {factory_name}

static int original_coefficient_position_{factory_name}(int i)
{{
{original_coefficient_position}
}}

{coordinate_finite_element_declaration}
static ufc_finite_element* create_coordinate_finite_element_{factory_name}(void)
{{
{create_coordinate_finite_element}
}}

{coordinate_dofmap_declaration}
static ufc_dofmap* create_coordinate_dofmap_{factory_name}(void)
{{
{create_coordinate_dofmap}
}}

{coordinate_mapping_declaration}
static ufc_coordinate_mapping* create_coordinate_mapping_{factory_name}(void)
{{
{create_coordinate_mapping}
}}

{finite_element_declaration}
static ufc_finite_element* create_finite_element_{factory_name}(int i)
{{
{create_finite_element}
}}

{dofmap_declaration}
static ufc_dofmap* create_dofmap_{factory_name}(int i)
{{
{create_dofmap}
}}

static ufc_cell_integral* create_cell_integral_{factory_name}(int subdomain_id)
{{
  {create_cell_integral}
}}

static ufc_exterior_facet_integral* create_exterior_facet_integral_{factory_name}(int subdomain_id)
{{
  {create_exterior_facet_integral}
}}

static ufc_interior_facet_integral* create_interior_facet_integral_{factory_name}(int subdomain_id)
{{
{create_interior_facet_integral}
}}

static ufc_vertex_integral* create_vertex_integral_{factory_name}(int subdomain_id)
{{
{create_vertex_integral}
}}

static ufc_custom_integral* create_custom_integral_{factory_name}(int subdomain_id)
{{
{create_custom_integral}
}}

static ufc_cell_integral* create_default_cell_integral_{factory_name}(void)
{{
{create_default_cell_integral}
}}

static ufc_exterior_facet_integral* create_default_exterior_facet_integral_{factory_name}(void)
{{
{create_default_exterior_facet_integral}
}}

static ufc_interior_facet_integral* create_default_interior_facet_integral_{factory_name}(void)
{{
{create_default_interior_facet_integral}
}}

static ufc_vertex_integral* create_default_vertex_integral_{factory_name}(void)
{{
{create_default_vertex_integral}
}}

static ufc_custom_integral* create_default_custom_integral_{factory_name}(void)
{{
