...
declaration = """
static ufc_coordinate_mapping* create_{factory_name}(void);
"""
...
static void compute_jacobians_{factory_name}(double* restrict J, int num_points,
...
static void compute_jacobian_determinants_{factory_name}(double* restrict detJ, int num_points,
                                                         const double* restrict J, int cell_orientation)
{{
{compute_jacobian_determinants}
}}

static void compute_jacobian_inverses_{factory_name}(double* restrict K, int num_points,
...
static void compute_physical_coordinates_{factory_name}(double* restrict x, int num_points,
                                                        const double* restrict X,
                                                        const double* restrict coordinate_dofs)
{{
...
static void compute_geometry_{factory_name}(double* restrict x, double* restrict J,
...
static void compute_midpoint_geometry_{factory_name}(double* restrict x, double* restrict J,
                                                     const double* restrict coordinate_dofs)
{{
{compute_midpoint_geometry}
}}

static void compute_reference_coordinates_{factory_name}(double* restrict X, int num_points,
                                                         const double* restrict x,
                                                         const double* restrict coordinate_dofs,
                                                         int cell_orientation)
{{
...
static void compute_reference_geometry_{factory_name}(double* restrict X, double* restrict J,
                                                      double* restrict detJ, double* restrict K,
                                                      int num_points, const double* restrict x,
                                                      const double* restrict coordinate_dofs,
                                                      int cell_orientation)
