...
_symbol_cache = {}
def create_symbol(variable, symbol_type, base_expr=None, base_op=0, cond=()):
    key = (variable, symbol_type, base_expr, base_op, cond)
    if key in _symbol_cache:
#        print "found %s in cache" %variable
        return _symbol_cache[key]
    symbol = Symbol(variable, symbol_type, base_expr, base_op, cond)
