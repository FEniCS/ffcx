    ...
    def create_argument(self, ufl_argument, derivatives, component, local_comp,
        ...
        if transformation == "affine":
            ...
            for multi in multiindices:
                ...
                mapping, basis = self._create_mapping_basis(component, deriv, ufl_argument, ffc_element) # AVG FIXME
        ...
        # Handle non-affine mappings.
            ...
            for multi in multiindices:
                ...
                for c in range(self.tdim):
                    ...
                    mapping, basis = self._create_mapping_basis(c + local_offset, deriv, ufl_argument, ffc_element) # AVG FIXME
                    if not mapping in code:
                        code[mapping] = []
