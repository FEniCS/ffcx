...
class CreateElementTests(unittest.TestCase):
    ...
    def testSimpleElements(self):
        ...
        ffc_element1 = FFCMixedElement([ffc_element, ffc_element], repr(element1))
        ...
        ffc_element2 = FFCMixedElement([ffc_element, ffc_element], repr(element2))
        ...
        ffc_element3 = FFCMixedElement([ffc_element]*9, repr(element3))
    ...
    def testComplexElements(self):
        ...
        ffc_element2 = FFCMixedElement([ffc_element, ffc_element1], repr(element2))
        ...
        ffc_element4 = FFCMixedElement([ffc_element3, ffc_element2], repr(element4))
